...
export const metadata: Metadata = {
  title: 'Monk Hud — Launching Soon',
  description:
    'Monk Hud is launching soon. Join the waitlist and design your focus environment.',
}

export default function HomePage() {
  return (
    <iframe
      src="/coming-soon/coming-soon.html"
      title="Monk Hud Coming Soon"
